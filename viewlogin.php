...
<head>
    ...
    <title>Bienvenido a FotoCasa, por favor, regístrese o inicie sesión</title>
            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">¡Bienvenido a FotoCasa!</h3>
                    </div>
                    <div style="margin-top: 15px; margin-left: 20px;">
                        Para acceder, inicia sesión:
                    </div>
                    <div class="panel-body">   
                        <form role="form" method="POST" action="phplogin.php">
                            <fieldset>
                                ...
                                <div class="form-group">
                                    ¿Has olvidado tu contraseña? Recupérala <a href="viewolvido.php">aquí</a>.
                                </div>
