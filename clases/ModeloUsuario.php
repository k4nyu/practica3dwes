...
//        $parametros["fechaalta"]= date_timestamp_get();
    ...
    function edit(Usuario $objeto, $loginpk){
        $sql="update $this->tabla set login=:login, clave=:clave, nombre=:nombre, apellido=:apellido, email=:email, isroot=:isroot"
                . ", rol=:rol  where login=:loginpk;";
        $parametros["login"]=$objeto->getLogin();
