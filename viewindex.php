        ...
        <div id="wrapper">
            <div>
                ...
                <form role="form" action="viewindex.php" method="POST">
                    ...
                    <input style="display: block; margin-left: 20px; float: left; margin-bottom: 10px;" class="btn btn-warning" type="reset" value="Vaciar campos"/>
                    <input style="display: block; margin-left: 47px; float: left;" class="btn btn-primary" type="submit" value="Filtrar"/>
                </form>
                
            </div>
            
            <div>
                <h1 class="page-header">Bienvenido a VentaCasa</h1>
                ...
                <?php foreach ($filas as $key => $objeto) {
